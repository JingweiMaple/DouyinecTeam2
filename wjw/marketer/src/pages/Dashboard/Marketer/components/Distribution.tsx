...
import { Table, Checkbox, Space, Tag ,Card} from 'tdesign-react';
...
export default function TableSingleSort() {
  const [sdata, setData] = useState([...initialData]);
  ...
  return (
    <Card title='销售订单排名' bordered={false} className={style.toolBar}>
