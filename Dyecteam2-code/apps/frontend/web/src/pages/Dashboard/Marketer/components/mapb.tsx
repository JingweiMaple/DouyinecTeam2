...
import { MouseTool,MouseToolDrawType  } from '@uiw/react-amap';
...
//       <Map zoom={9}  center={[116.400274, 39.905812]}>
//         {(props) => {
...
const Mount = () => (
  <APILoader akey="1acd0b23703356a683d8b4c0c9daa645&plugin=AMap.MouseTool">
    {/* <Demo /> */}
    <Example />
    <MapDraw />
  </APILoader>
