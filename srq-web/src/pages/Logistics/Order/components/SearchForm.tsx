          ...
          <Col flex='1'>
            <Row gutter={[16, 16]}>
              <Col span={3} xs={12} sm={6} xl={3}>
                <FormItem label='订单名称' name='name'>
                  <Input placeholder='请输入订单名称' />
                </FormItem>
              </Col>
              <Col span={3} xs={12} sm={6} xl={3}>
                <FormItem label='订单状态' name='status'>
                  <Select options={CONTRACT_STATUS_OPTIONS} placeholder='请选择订单状态' />
                </FormItem>
              </Col>
              <Col span={3} xs={12} sm={6} xl={3}>
                <FormItem label='订单编号' name='number'>
                  <Input placeholder='请输入订单编号' />
                </FormItem>
              </Col>
              <Col span={3} xs={12} sm={6} xl={3}>
                <FormItem label='订单类型' name='type'>
                  <Select options={CONTRACT_TYPE_OPTIONS} placeholder='请选择订单类型' />
                </FormItem>
              </Col>
            </Row>
          </Col>
